    ...
    <main className="min-h-screen bg-gray-100 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <section className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <CitizenOptions link="/citizen/citizenid" emoji="🙎" emojibg="bg-purple-100 text-purple-700" heading="Personal Information" desc="Get Your all personal Information of this platform."  />
